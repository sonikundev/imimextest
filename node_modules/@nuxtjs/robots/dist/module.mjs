...
import { useNuxt, createResolver, addTemplate, loadNuxtModuleInstance, useLogger, hasNuxtModule, getNuxtModuleVersion, hasNuxtModuleCompatibility, defineNuxtModule, addImports, addPlugin, addComponent, addServerHandler, addServerPlugin } from '@nuxt/kit';
import { defu } from 'defu';
import { installNuxtSiteConfig, updateSiteConfig } from 'nuxt-site-config-kit';
import { relative } from 'pathe';
import { readPackageJSON } from 'pkg-types';
import { isInternalRoute, mergeOnKey, asArray, parseRobotsTxt, validateRobots, indexableFromGroup, normaliseRobotsRouteRule } from '../dist/runtime/util.js';
