import {
  script as script3
} from "./chunk-SA3K2XX3.js";
import "./chunk-PDBPBVXL.js";
import {
  Ripple
...
import { resolveComponent, openBlock as openBlock5, createElementBlock as createElementBlock5, mergeProps as mergeProps5, renderSlot, createCommentVNode, createElementVNode as createElementVNode5, createBlock, withCtx, resolveDynamicComponent, Fragment, renderList, createTextVNode, toDisplayString } from "vue";
var script$1 = {
  name: "BaseCarousel",
  "extends": script,
  props: {
...
var _hoisted_25 = ["data-p-carousel-item-active", "data-p-carousel-item-start", "data-p-carousel-item-end"];
...
function render5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock5(), createElementBlock5("div", mergeProps5({
    "class": _ctx.cx("root"),
    role: "region"
  }, _ctx.ptmi("root")), [_ctx.$slots.header ? (openBlock5(), createElementBlock5("div", mergeProps5({
    key: 0,
    "class": _ctx.cx("header")
  }, _ctx.ptm("header")), [renderSlot(_ctx.$slots, "header")], 16)) : createCommentVNode("", true), !$options.empty ? (openBlock5(), createElementBlock5("div", mergeProps5({
    key: 1,
    "class": [_ctx.cx("contentContainer"), _ctx.containerClass]
  }, _ctx.ptm("contentContainer")), [createElementVNode5("div", mergeProps5({
    "class": [_ctx.cx("content"), _ctx.contentClass],
    "aria-live": $data.allowAutoplay ? "polite" : "off"
  }, _ctx.ptm("content")), [_ctx.showNavigators ? (openBlock5(), createBlock(_component_Button, mergeProps5({
    key: 0,
    ...
    icon: withCtx(function(slotProps) {
      return [renderSlot(_ctx.$slots, "previcon", {}, function() {
        return [(openBlock5(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronUpIcon" : "ChevronLeftIcon"), mergeProps5({
          "class": slotProps.icon
        }, _ctx.ptm("pcPrevButton")["icon"]), null, 16, ["class"]))];
      })];
    }),
    _: 3
  }, 16, ["class", "disabled", "aria-label", "unstyled", "onClick", "pt"])) : createCommentVNode("", true), createElementVNode5("div", mergeProps5({
  ...
  }, _ctx.ptm("viewport")), [createElementVNode5("div", mergeProps5({
    ref: "itemsContainer",
  ...
  }, _ctx.ptm("itemList")), [$options.isCircular() ? (openBlock5(true), createElementBlock5(Fragment, {
    key: 0
  ...
  }), 128)) : createCommentVNode("", true), (openBlock5(true), createElementBlock5(Fragment, null, renderList(_ctx.value, function(item2, index) {
    return openBlock5(), createElementBlock5("div", mergeProps5({
      key: index,
      "class": _ctx.cx("item", {
        index
  ...
  }), 128)), $options.isCircular() ? (openBlock5(true), createElementBlock5(Fragment, {
    key: 1
  ...
  }), 128)) : createCommentVNode("", true)], 16)], 16), _ctx.showNavigators ? (openBlock5(), createBlock(_component_Button, mergeProps5({
    key: 1,
    ...
    icon: withCtx(function(slotProps) {
      return [renderSlot(_ctx.$slots, "nexticon", {}, function() {
        return [(openBlock5(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronDownIcon" : "ChevronRightIcon"), mergeProps5({
          "class": slotProps["class"]
        }, _ctx.ptm("pcNextButton")["icon"]), null, 16, ["class"]))];
      })];
    }),
    _: 3
  }, 16, ["class", "disabled", "aria-label", "unstyled", "onClick", "pt"])) : createCommentVNode("", true)], 16, _hoisted_15), $options.totalIndicators >= 0 && _ctx.showIndicators ? (openBlock5(), createElementBlock5("ul", mergeProps5({
    key: 0,
  ...
  }, _ctx.ptm("indicatorList")), [(openBlock5(true), createElementBlock5(Fragment, null, renderList($options.totalIndicators, function(indicator2, i) {
    ...
    }), [createElementVNode5("button", mergeProps5({
  ...
  }), _ctx.$slots.footer ? (openBlock5(), createElementBlock5("div", mergeProps5({
    key: 3,
