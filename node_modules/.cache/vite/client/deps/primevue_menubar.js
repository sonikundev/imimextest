...
import {
  Ripple
} from "./chunk-MAEZEORH.js";
import "./chunk-25BMG73E.js";
...
import { mergeProps as mergeProps4, resolveComponent, resolveDirective, openBlock as openBlock4, createElementBlock as createElementBlock4, Fragment, renderList, createElementVNode as createElementVNode4, withDirectives, createBlock, resolveDynamicComponent, normalizeClass, createCommentVNode, toDisplayString, normalizeStyle, renderSlot, createVNode, normalizeProps, guardReactiveProps } from "vue";
var script$2 = {
  name: "BaseMenubar",
  "extends": script,
  props: {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock4(), createElementBlock4("ul", mergeProps4({
    "class": $props.level === 0 ? _ctx.cx("rootList") : _ctx.cx("submenu")
  }, $props.level === 0 ? _ctx.ptm("rootList") : _ctx.ptm("submenu")), [(openBlock4(true), createElementBlock4(Fragment, null, renderList($props.items, function(processedItem, index) {
    return openBlock4(), createElementBlock4(Fragment, {
      key: $options.getItemKey(processedItem)
    }, [$options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock4(), createElementBlock4("li", mergeProps4({
      key: 0,
    ...
    }), [createElementVNode4("div", mergeProps4({
      ...
      ref_for: true
    }, $options.getPTOptions(processedItem, index, "itemContent")), [!$props.templates.item ? withDirectives((openBlock4(), createElementBlock4("a", mergeProps4({
      key: 0,
      ...
      "aria-hidden": "true",
      ref_for: true
    }, $options.getPTOptions(processedItem, index, "itemLink")), [$props.templates.itemicon ? (openBlock4(), createBlock(resolveDynamicComponent($props.templates.itemicon), {
      key: 0,
      item: processedItem.item,
      "class": normalizeClass(_ctx.cx("itemIcon"))
    }, null, 8, ["item", "class"])) : $options.getItemProp(processedItem, "icon") ? (openBlock4(), createElementBlock4("span", mergeProps4({
      key: 1,
      "class": [_ctx.cx("itemIcon"), $options.getItemProp(processedItem, "icon")],
      ref_for: true
    }, $options.getPTOptions(processedItem, index, "itemIcon")), null, 16)) : createCommentVNode("", true), createElementVNode4("span", mergeProps4({
      id: $options.getItemLabelId(processedItem),
      "class": _ctx.cx("itemLabel"),
      ref_for: true
    }, $options.getPTOptions(processedItem, index, "itemLabel")), toDisplayString($options.getItemLabel(processedItem)), 17, _hoisted_4), $options.getItemProp(processedItem, "items") ? (openBlock4(), createElementBlock4(Fragment, {
      key: 2
    }, [$props.templates.submenuicon ? (openBlock4(), createBlock(resolveDynamicComponent($props.templates.submenuicon), {
      key: 0,
      root: $props.root,
      active: $options.isItemActive(processedItem),
      "class": normalizeClass(_ctx.cx("submenuIcon"))
    }, null, 8, ["root", "active", "class"])) : (openBlock4(), createBlock(resolveDynamicComponent($props.root ? "AngleDownIcon" : "AngleRightIcon"), mergeProps4({
      key: 1,
      "class": _ctx.cx("submenuIcon"),
      ref_for: true
    }, $options.getPTOptions(processedItem, index, "submenuIcon")), null, 16, ["class"]))], 64)) : createCommentVNode("", true)], 16, _hoisted_3)), [[_directive_ripple]]) : (openBlock4(), createBlock(resolveDynamicComponent($props.templates.item), {
      key: 1,
      item: processedItem.item,
      root: $props.root,
    ...
    }, null, 8, ["item", "root", "hasSubmenu", "label", "props"]))], 16, _hoisted_24), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock4(), createBlock(_component_MenubarSub, {
      key: 0,
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock4(), createElementBlock4("div", mergeProps4({
    ref: $options.containerRef,
    "class": _ctx.cx("root")
  }, _ctx.ptmi("root")), [_ctx.$slots.start ? (openBlock4(), createElementBlock4("div", mergeProps4({
    key: 0,
    "class": _ctx.cx("start")
    ...
    return [_ctx.model && _ctx.model.length > 0 ? (openBlock4(), createElementBlock4("a", mergeProps4({
      key: 0,
      ref: "menubutton",
      role: "button",
      tabindex: "0",
  ...
  }, null, 8, ["id", "items", "templates", "mobileActive", "aria-activedescendant", "menuId", "focusedItemId", "activeItemPath", "aria-labelledby", "aria-label", "pt", "unstyled", "onFocus", "onBlur", "onKeydown", "onItemClick", "onItemMouseenter", "onItemMousemove"]), _ctx.$slots.end ? (openBlock4(), createElementBlock4("div", mergeProps4({
    key: 1,
    "class": _ctx.cx("end")
