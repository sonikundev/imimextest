...
import { mergeProps as mergeProps2, resolveComponent, resolveDirective, withDirectives, openBlock as openBlock2, createBlock, resolveDynamicComponent, withCtx, renderSlot, normalizeClass, createElementBlock as createElementBlock2, createCommentVNode, createElementVNode as createElementVNode2, toDisplayString } from "vue";
...
var script5 = {
  ...
  computed: {
    ...
    attrs: function attrs() {
      return mergeProps2(this.asAttrs, this.a11yAttrs, this.getPTOptions("root"));
    },
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.asChild ? withDirectives((openBlock2(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps2({
    key: 0,
    "class": _ctx.cx("root")
  }, $options.attrs), {
    "default": withCtx(function() {
      return [renderSlot(_ctx.$slots, "default", {}, function() {
        return [_ctx.loading ? renderSlot(_ctx.$slots, "loadingicon", {
          ...
          return [_ctx.loadingIcon ? (openBlock2(), createElementBlock2("span", mergeProps2({
            key: 0,
            "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon"), _ctx.loadingIcon]
          }, _ctx.ptm("loadingIcon")), null, 16)) : (openBlock2(), createBlock(_component_SpinnerIcon, mergeProps2({
            key: 1,
          ...
          return [_ctx.icon ? (openBlock2(), createElementBlock2("span", mergeProps2({
            key: 0,
            "class": [_ctx.cx("icon"), _ctx.icon, _ctx.iconClass]
          }, _ctx.ptm("icon")), null, 16)) : createCommentVNode("", true)];
        }), createElementVNode2("span", mergeProps2({
          "class": _ctx.cx("label")
        }, _ctx.ptm("label")), toDisplayString(_ctx.label || " "), 17), _ctx.badge ? (openBlock2(), createBlock(_component_Badge, mergeProps2({
          key: 2,
          value: _ctx.badge,
