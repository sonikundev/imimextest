...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout-wrapper fadein animation-duration-400 animation-iteration-1" }, _attrs))} data-v-bcd4ac32><div class="content" data-v-bcd4ac32><div style="${ssrRenderStyle({ "padding": "0px" })}" data-v-bcd4ac32>`);
            ...
            if (item2.to) {
              _push2(ssrRenderComponent(_component_NuxtLink, mergeProps({
                ...
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span class="${ssrRenderClass(item2.icon)}" data-v-bcd4ac32${_scopeId2}></span><span class="ml-2" data-v-bcd4ac32${_scopeId2}>${ssrInterpolate(item2.label)}</span>`);
                    if (item2.badge) {
                    ...
                    if (item2.shortcut) {
                      _push3(`<span class="ml-auto border border-surface rounded bg-emphasis text-muted-color text-xs p-1" data-v-bcd4ac32${_scopeId2}>${ssrInterpolate(item2.shortcut)}</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (hasSubmenu) {
                      _push3(`<i class="${ssrRenderClass(["pi pi-angle-down", { "pi-angle-down ml-2": root2, "pi-angle-right ml-auto": !root2 }])}" data-v-bcd4ac32${_scopeId2}></i>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
              ...
              _push2(`<a${ssrRenderAttrs(mergeProps({ class: "flex items-center" }, props.action, ssrGetDirectiveProps(_ctx, _directive_ripple)))} data-v-bcd4ac32${_scopeId}><span class="${ssrRenderClass(item2.icon)}" data-v-bcd4ac32${_scopeId}></span><span class="ml-2" data-v-bcd4ac32${_scopeId}>${ssrInterpolate(item2.label)}</span>`);
              if (item2.badge) {
              ...
              if (item2.shortcut) {
                _push2(`<span class="ml-auto border border-surface rounded bg-emphasis text-muted-color text-xs p-1" data-v-bcd4ac32${_scopeId}>${ssrInterpolate(item2.shortcut)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (hasSubmenu) {
                _push2(`<i class="${ssrRenderClass(["pi pi-angle-down", { "pi-angle-down ml-2": root2, "pi-angle-right ml-auto": !root2 }])}" data-v-bcd4ac32${_scopeId}></i>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</a>`);
      ...
      _push(`</div><div class="backgroundContent" data-v-bcd4ac32>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div><div class="footer grid" data-v-bcd4ac32><div class="col-2" data-v-bcd4ac32><span class="pi pi-map-marker" data-v-bcd4ac32></span> Queretaro Mx. </div><div class="col-2" data-v-bcd4ac32><span class="pi pi-envelope" data-v-bcd4ac32></span> correoimimex@imimex.com </div><div class="col-2" data-v-bcd4ac32><span class="pi pi-phone" data-v-bcd4ac32></span> +52 4422 33 405 </div><div class="col-6 flex align-items-center justify-content-end" data-v-bcd4ac32><span class="pi pi-linkedin pr-5" data-v-bcd4ac32></span></div></div></div>`);
    };
  }
};
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bcd4ac32"]]);

export { _default as default };
//# sourceMappingURL=default-BBcUpBcg.mjs.map
