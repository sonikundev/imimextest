...
const _imports_0 = "" + buildAssetsURL("skdocslogo.BlXbKADJ.png");
const _imports_1 = "" + buildAssetsURL("skterminallogo.BEoGZCJk.png");
const _imports_2 = "" + buildAssetsURL("skflightslogo.B1_C3hgm.png");
const _sfc_main = {
  __name: "index",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid mx-3 fadein animation-duration-400 animation-iteration-1 mb-5" }, _attrs))}><div class="col-12 sm:col-12 md:col-6 lg:col-6 xl:col-6"><p class="firstBannerTitle"> Innovaci\xF3n y Tecnolog\xEDa </p><p class="firstBannerSubTitle"> &quot;En el coraz\xF3n de nuestra empresa de tecnolog\xEDa, la innovaci\xF3n es el motor que impulsa cada soluci\xF3n.&quot; </p><p class="firstBannerSubTitle2"> -imimex </p>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "consultoriaCard" }, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> El servicio de desarrollo a la medida crea software personalizado que se alinea con los objetivos y necesidades espec\xEDficas de cada empresa para proporcionar una ventaja competitiva. </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " El servicio de desarrollo a la medida crea software personalizado que se alinea con los objetivos y necesidades espec\xEDficas de cada empresa para proporcionar una ventaja competitiva. ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "consultoriaCard" }, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-clipboard pr-1"${_scopeId2}></i> Servicio de consultor\xEDa en software </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-clipboard pr-1" }),
                      createTextVNode(" Servicio de consultor\xEDa en software ")
                    ])
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> El servicio de consultor\xEDa en software ofrece asesoramiento experto para optimizar, implementar y gestionar soluciones tecnol\xF3gicas que mejoren la eficiencia y productividad de las empresas. </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " El servicio de consultor\xEDa en software ofrece asesoramiento experto para optimizar, implementar y gestionar soluciones tecnol\xF3gicas que mejoren la eficiencia y productividad de las empresas. ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "consultoriaCard" }, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-comments pr-1"${_scopeId2}></i> Servicio de soporte t\xE9cnico y mesa de ayuda </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-comments pr-1" }),
                      createTextVNode(" Servicio de soporte t\xE9cnico y mesa de ayuda ")
                    ])
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> El servicio de soporte t\xE9cnico y mesa de ayuda proporciona asistencia especializada para resolver problemas t\xE9cnicos, garantizar el funcionamiento continuo de sistemas y ofrecer soporte a los usuarios finales. </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " El servicio de soporte t\xE9cnico y mesa de ayuda proporciona asistencia especializada para resolver problemas t\xE9cnicos, garantizar el funcionamiento continuo de sistemas y ofrecer soporte a los usuarios finales. ")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=index-BgYtrBti.mjs.map
