import { version, unref, inject, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, readonly, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, getCurrentInstance, onMounted, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toRaw, markRaw } from 'vue';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-gnzT7GEL.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-CFTNb7oN.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ezDPJb7Q.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-HLBQUVsg.mjs').then((r) => r.default || r));
...
export { BaseStyle as B, PrimeVueService as P, _export_sfc as _, resolveRouteObject as a, navigateTo as b, useRuntimeConfig as c, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
