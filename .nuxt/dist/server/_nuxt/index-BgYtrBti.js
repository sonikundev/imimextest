...
import { s as script$f, B as BaseDirective, a as script$g, U as UniqueComponentId, b as script$h, R as Ripple } from "./index-CjJ3OlNo.js";
import { openBlock, createElementBlock, mergeProps, createElementVNode, renderSlot, createBlock, Teleport, createCommentVNode, resolveComponent, resolveDirective, resolveDynamicComponent, createVNode, withCtx, withDirectives, normalizeProps, guardReactiveProps, Transition, normalizeClass, normalizeStyle, Fragment, renderList, createTextVNode, toDisplayString, ref, useSSRContext } from "vue";
...
const _imports_0 = "" + __buildAssetsURL("skdocslogo.BlXbKADJ.png");
const _imports_1 = "" + __buildAssetsURL("skterminallogo.BEoGZCJk.png");
const _imports_2 = "" + __buildAssetsURL("skflightslogo.B1_C3hgm.png");
const _sfc_main = {
  __name: "index",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "consultoriaCard" }, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-code pr-1"${_scopeId2}></i> Servicio de desarrollo a la medida </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-code pr-1" }),
                      createTextVNode(" Servicio de desarrollo a la medida ")
                    ])
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> El servicio de desarrollo a la medida crea software personalizado que se alinea con los objetivos y necesidades específicas de cada empresa para proporcionar una ventaja competitiva. </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " El servicio de desarrollo a la medida crea software personalizado que se alinea con los objetivos y necesidades específicas de cada empresa para proporcionar una ventaja competitiva. ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</div></div><div class="col-12 sm:col-12 md:col-4 lg:col-4 xl:col-4 my-1" style="${ssrRenderStyle({ "padding": "0px" })}"${_scopeId}><div class="card"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Card, { class: "consultoriaCard" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img alt="user header" src="https://primefaces.org/cdn/primevue/images/usercard.png"${_scopeId2}>`);
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-clipboard pr-1"${_scopeId2}></i> Servicio de consultoría en software </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-clipboard pr-1" }),
                      createTextVNode(" Servicio de consultoría en software ")
                    ])
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> El servicio de consultoría en software ofrece asesoramiento experto para optimizar, implementar y gestionar soluciones tecnológicas que mejoren la eficiencia y productividad de las empresas. </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " El servicio de consultoría en software ofrece asesoramiento experto para optimizar, implementar y gestionar soluciones tecnológicas que mejoren la eficiencia y productividad de las empresas. ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "consultoriaCard" }, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-comments pr-1"${_scopeId2}></i> Servicio de soporte técnico y mesa de ayuda </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-comments pr-1" }),
                      createTextVNode(" Servicio de soporte técnico y mesa de ayuda ")
                    ])
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> El servicio de soporte técnico y mesa de ayuda proporciona asistencia especializada para resolver problemas técnicos, garantizar el funcionamiento continuo de sistemas y ofrecer soporte a los usuarios finales. </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " El servicio de soporte técnico y mesa de ayuda proporciona asistencia especializada para resolver problemas técnicos, garantizar el funcionamiento continuo de sistemas y ofrecer soporte a los usuarios finales. ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</div></div><div class="col-12 sm:col-12 md:col-12 lg:col-12 xl:col-12 flex align-items-center justify-content-center"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "grid" }, [
                createVNode("div", {
                  ...
                  createVNode("p", { class: "consultoriaSoftware" }, " Consultoria en Desarrollo de Software ")
                ]),
                createVNode("div", {
                  class: "col-12 sm:col-12 md:col-4 lg:col-4 xl:col-4 my-1",
                  style: { "padding": "0px" }
                }, [
                  createVNode("div", { class: "card" }, [
                    createVNode(_component_Card, { class: "consultoriaCard" }, {
                      header: withCtx(() => [
                        createVNode("img", {
                          alt: "user header",
                          src: "https://primefaces.org/cdn/primevue/images/usercard.png"
                ...
                createVNode("div", { class: "col-12 sm:col-12 md:col-12 lg:col-12 xl:col-12 flex align-items-center justify-content-center" }, [
      ...
      _push(ssrRenderComponent(_component_Card, { style: { "width": "100%" } }, {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid"${_scopeId}><div class="col-12 flex align-items-center justify-content-center" style="${ssrRenderStyle({ "padding": "0px" })}"${_scopeId}><p${_scopeId}><svg class="controlInstrumentacion" version="1.1" id="L6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve"${_scopeId}><rect fill="none" stroke="black" stroke-width="4" x="25" y="25" width="50" height="50"${_scopeId}><animateTransform attributeName="transform" dur="1.5s" from="0 50 50" to="180 50 50" type="rotate" id="strokeBox" attributeType="XML" begin="rectBox.end"${_scopeId}></animateTransform></rect><rect x="27" y="27" fill="#black" width="46" height="50"${_scopeId}><animate attributeName="height" dur="2.3s" attributeType="XML" from="50" to="0" id="rectBox" fill="freeze" begin="0s;strokeBox.end"${_scopeId}></animate></rect></svg></p><p class="consultoriaSoftware"${_scopeId}> Software Propietario </p></div><div class="col-12 sm:col-12 md:col-4 lg:col-4 xl:col-4 my-1" style="${ssrRenderStyle({ "padding": "0px" })}"${_scopeId}><div class="card"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Card, { class: "softwarePropietarioCard" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img alt="user header"${ssrRenderAttr("src", _imports_0)} class="w-full"${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      alt: "user header",
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-code pr-1"${_scopeId2}></i> skdocs </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-code pr-1" }),
                      createTextVNode(" skdocs ")
                    ])
                  ];
                }
              }),
              subtitle: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span${_scopeId2}> Sector Administrativo </span>`);
                } else {
                  return [
                    createVNode("span", null, " Sector Administrativo ")
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="m-0 infoCard"${_scopeId2}> Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi quibusdam nulla inventore vero, quasi eum necessitatibus doloribus ab consectetur? Libero iure, id magnam quos adipisci alias amet omnis ea totam! </p>`);
                } else {
                  return [
                    createVNode("p", { class: "m-0 infoCard" }, " Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi quibusdam nulla inventore vero, quasi eum necessitatibus doloribus ab consectetur? Libero iure, id magnam quos adipisci alias amet omnis ea totam! ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "softwarePropietarioCard" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img alt="user header"${ssrRenderAttr("src", _imports_1)} class="w-full"${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      alt: "user header",
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-code pr-1"${_scopeId2}></i> skterminal </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-code pr-1" }),
                      createTextVNode(" skterminal ")
                    ])
                  ];
                }
              }),
              subtitle: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span${_scopeId2}> Sector Industrial </span>`);
                } else {
                  return [
                    createVNode("span", null, " Sector Industrial ")
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(ssrRenderComponent(_component_Card, { class: "softwarePropietarioCard" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img alt="user header"${ssrRenderAttr("src", _imports_2)} class="w-full"${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      alt: "user header",
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="titleCard"${_scopeId2}><i class="pi pi-code pr-1"${_scopeId2}></i> skflights </span>`);
                } else {
                  return [
                    createVNode("span", { class: "titleCard" }, [
                      createVNode("i", { class: "pi pi-code pr-1" }),
                      createTextVNode(" skflights ")
                    ])
                  ];
                }
              }),
              subtitle: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span${_scopeId2}> Sector Administrativo Aeroportuario </span>`);
                } else {
                  return [
                    createVNode("span", null, " Sector Administrativo Aeroportuario ")
                  ];
                }
              }),
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            return [
              createVNode("div", { class: "grid" }, [
                createVNode("div", {
                  ...
                  createVNode("p", { class: "consultoriaSoftware" }, " Software Propietario ")
                ]),
                createVNode("div", {
                  class: "col-12 sm:col-12 md:col-4 lg:col-4 xl:col-4 my-1",
                  style: { "padding": "0px" }
                  ...
                  createVNode("div", { class: "card" }, [
                    createVNode(_component_Card, { class: "softwarePropietarioCard" }, {
                      header: withCtx(() => [
                        createVNode("img", {
                          alt: "user header",
                          src: _imports_0,
      ...
      _push(ssrRenderComponent(_component_Card, { style: { "width": "100%" } }, {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid"${_scopeId}><div class="col-12 flex align-items-center justify-content-center" style="${ssrRenderStyle({ "padding": "0px" })}"${_scopeId}><p${_scopeId}></p><p class="consultoriaSoftware"${_scopeId}> Testimonios </p></div><div class="col-12" style="${ssrRenderStyle({ "padding": "0px" })}"${_scopeId}><div class="card"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Carousel, {
              ...
              item: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_Card, { style: { "width": "100%", "overflow": "hidden" } }, {
                  ...
                  return [
                    createVNode(_component_Card, { style: { "width": "100%", "overflow": "hidden" } }, {
                      header: withCtx(() => []),
                      title: withCtx(() => [
                        createVNode("span", { class: "pi pi-file-check" }),
                        createTextVNode(" Proyecto ")
            ...
            return [
              createVNode("div", { class: "grid" }, [
                createVNode("div", {
                  ...
                  createVNode("p"),
                  createVNode("p", { class: "consultoriaSoftware" }, " Testimonios ")
                ]),
                createVNode("div", {
                  class: "col-12",
                  style: { "padding": "0px" }
      ...
      _push(ssrRenderComponent(_component_Card, { style: { "width": "100%" } }, {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="col-12 sm:col-12 md:col-12 lg:col-2 xl:col-2 flex align-items-center justify-content-center" style="${ssrRenderStyle({})}"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Image, {
            ...
            return [
              createVNode("div", { class: "grid" }, [
                createVNode("div", {
                  class: "col-12 sm:col-12 md:col-12 lg:col-2 xl:col-2 flex align-items-center justify-content-center",
                  style: {}
                }, [
...
//# sourceMappingURL=index-BgYtrBti.js.map
