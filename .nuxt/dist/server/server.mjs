import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, readonly, onMounted, nextTick, watch, markRaw, defineComponent, computed, provide, Suspense, mergeProps, Transition, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-gnzT7GEL.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-CFTNb7oN.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BgYtrBti.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-BpFYTeSs.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-ezDPJb7Q.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-HLBQUVsg.js").then((r) => r.default || r));
