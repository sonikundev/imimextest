...
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/unstorage/drivers/lru-cache.mjs';
import { html as html$1 } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/satori-html/dist/index.js';
import { consola, createConsola } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/consola/dist/index.mjs';
import { createGenerator } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/@unocss/preset-wind/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, joinRelativeURL, withoutLeadingSlash } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/image-size/dist/index.js';
import playwrightCore from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/playwright-core/index.mjs';
import { Launcher } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/chrome-launcher/dist/index.js';
...
import { stringify, parse, uneval } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/devalue/index.js';
import destr from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/vue/server-renderer/index.mjs';
...
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/unhead/dist/index.mjs';
...
import { Resvg } from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/satori/dist/index.js';
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/rodrigomartinez/Desktop/imimextest/.nuxt/cache/nuxt-og-image@3.0.0-rc.64/_fonts"},{"baseName":"server","dir":"/Users/rodrigomartinez/Desktop/imimextest/server/assets"}];
...
const _TUnDe0oYaA = defineNitroPlugin$1(async (nitro) => {
  return;
});
...
const styles$2 = [
  ,
  BaseStyle && BaseStyle.getStyleSheet ? BaseStyle.getStyleSheet(undefined, styleProps) : '',CardStyle && CardStyle.getStyleSheet ? CardStyle.getStyleSheet(undefined, styleProps) : '',ImageStyle && ImageStyle.getStyleSheet ? ImageStyle.getStyleSheet(undefined, styleProps) : '',BadgeStyle && BadgeStyle.getStyleSheet ? BadgeStyle.getStyleSheet(undefined, styleProps) : '',MenubarStyle && MenubarStyle.getStyleSheet ? MenubarStyle.getStyleSheet(undefined, styleProps) : '',RippleStyle && RippleStyle.getStyleSheet ? RippleStyle.getStyleSheet(undefined, styleProps) : '',ButtonStyle && ButtonStyle.getStyleSheet ? ButtonStyle.getStyleSheet(undefined, styleProps) : ''
].join('');
...
const themes = [
    ...
    BaseStyle && BaseStyle.getThemeStyleSheet ? BaseStyle.getThemeStyleSheet(undefined, styleProps) : '',CardStyle && CardStyle.getThemeStyleSheet ? CardStyle.getThemeStyleSheet(undefined, styleProps) : '',ImageStyle && ImageStyle.getThemeStyleSheet ? ImageStyle.getThemeStyleSheet(undefined, styleProps) : '',BadgeStyle && BadgeStyle.getThemeStyleSheet ? BadgeStyle.getThemeStyleSheet(undefined, styleProps) : '',MenubarStyle && MenubarStyle.getThemeStyleSheet ? MenubarStyle.getThemeStyleSheet(undefined, styleProps) : '',RippleStyle && RippleStyle.getThemeStyleSheet ? RippleStyle.getThemeStyleSheet(undefined, styleProps) : '',ButtonStyle && ButtonStyle.getThemeStyleSheet ? ButtonStyle.getThemeStyleSheet(undefined, styleProps) : ''
].join('');
...
const _lazy_37WNMe = () => Promise.resolve().then(function () { return font$1; });
const _lazy_a1Ophi = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_AnA157 = () => Promise.resolve().then(function () { return image$1; });
...
const handlers = [
  ...
  { route: '/__og-image__/font/**', handler: _lazy_37WNMe, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_a1Ophi, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_AnA157, lazy: true, middleware: false, method: undefined },
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///Users/rodrigomartinez/Desktop/imimextest/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"@/public/IMIMEX_Isotipo_Blanco.png"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"IMIMEX","titleTemplate":"%s","htmlAttrs":{}};
...
const getServerEntry = () => import('file:///Users/rodrigomartinez/Desktop/imimextest/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const componentNames = [{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"tBHg51xiAt","pascalName":"Frame","kebabName":"frame","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"Sqc3OTP2KQ","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"NEgliLpoqF","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"q432NYEB0T","pascalName":"Pergel","kebabName":"pergel","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"YDrRRvPRVl","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/rodrigomartinez/Desktop/imimextest/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
